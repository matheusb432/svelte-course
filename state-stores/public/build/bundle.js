...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$4, 31, 4, 751);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 24, 2, 493);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$4, 25, 2, 512);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$4, 23, 0, 486);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 35, 6, 903);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (33:4) {#each $cartItems as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(33:4) {#each $cartItems as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 29, 2, 650);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$3, 30, 2, 666);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$3, 28, 0, 638);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 16, 4, 303);
    			attr_dev(h2, "class", "svelte-12wunlm");
    			add_location(h2, file$2, 17, 4, 324);
    			attr_dev(p, "class", "svelte-12wunlm");
    			add_location(p, file$2, 18, 4, 345);
    			add_location(div0, file$2, 15, 2, 293);
    			add_location(div1, file$2, 20, 2, 377);
    			attr_dev(div2, "class", "product svelte-12wunlm");
    			add_location(div2, file$2, 14, 0, 269);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 6, 2, 130);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file$1, 5, 0, 118);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
